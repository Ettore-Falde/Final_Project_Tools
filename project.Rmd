...
```{r}
#london_data<- read.csv("survey_results_public.csv") command used to modify the original dataset

#london_data<- london_data%>%filter(Country == "United Kingdom")

#write.csv(london_data, "survey_results_public2.csv")

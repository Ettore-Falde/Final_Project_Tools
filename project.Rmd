...
```{r}
ggplot(mydb, aes(x=years_at_company, y=monthly_income, colour=gender))+geom_point()+ geom_smooth(method="lm")
```

**Taking in consideration London**
```{r}
ggplot(mydb%>%filter(city=="London"), aes(x=years_at_company, y=monthly_income, colour=gender))+geom_point()+ geom_smooth(method="lm")
```

**Taking in consideration Barcelona**
```{r}
ggplot(mydb%>%filter(city=="Barcelona"), aes(x=years_at_company, y=monthly_income, colour=gender))+geom_point()+ geom_smooth(method="lm")
```
